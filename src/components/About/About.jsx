  ...
  return (
    <section className={aboutStyles.about}>
      ...
      <section className={aboutStyles.aboutSocials}>
        <section className={aboutStyles.socialIcons}>
          <div className={aboutStyles.githubBox}>
            <svg
              ref={githubRef}
          ...
          <div className={aboutStyles.linkedInBox}>
            <svg
              ref={linkedInRef}
              onMouseEnter={blurOthers}
              onMouseLeave={revertBlur}
          ...
          <div className={aboutStyles.xBox}>
            <svg
              ref={xRef}
              onMouseEnter={blurOthers}
              onMouseLeave={revertBlur}
          ...
          <div className={aboutStyles.igBox}>
            <svg
              ref={igRef}
              onMouseEnter={blurOthers}
              onMouseLeave={revertBlur}
          ...
          <div className={aboutStyles.fbBox}>
            <svg
              ref={fbRef}
              onMouseEnter={blurOthers}
              onMouseLeave={revertBlur}
          ...
          <div className={aboutStyles.youtubeBox}>
            <svg
              ref={youtubeRef}
              onMouseEnter={blurOthers}
              onMouseLeave={revertBlur}
          ...
          <div className={aboutStyles.mediumBox}>
            <svg
              ref={mediumRef}
              onMouseEnter={blurOthers}
              onMouseLeave={revertBlur}

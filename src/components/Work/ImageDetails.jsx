...
import fastmarketxImg from "../../assets/Works/fastmarketx.png";
...
const images = [
  {
    ...
    links: {
      live: "https://fastmarketx.vercel.app/",
      code: "https://github.com/asdacosta/fastmarketx",
    },
    index: "firstImg",
    icon: (
  ...
  },
  {
    ...
    index: "fourthImg",
    icon: (
      <svg className={workStyles.resumeIcon} viewBox="0 0 384 512">
  ...
  },
  {
    ...
    index: "fifthImg",
    icon: (
      <svg className={workStyles.gameIcon} viewBox="0 0 640 512">

...
const icons = [
  {
    box: skillStyles.tsBox,
    icon: skillStyles.tsIcon,
    svg: (
      <svg viewBox="0 0 128 128" className={skillStyles.tsIcon}>
        <path
          fill="#007acc"
  ...
  {
    box: skillStyles.jsBox,
    icon: skillStyles.jsIcon,
    svg: (
  ...
  {
    box: skillStyles.cBox,
    icon: skillStyles.cIcon,
    svg: (
  ...
  {
    box: skillStyles.pythonBox,
    icon: skillStyles.pythonIcon,
    svg: (
  ...
  return (
    <section>
      {icons.map((item, index) => (
        <div key={index} className={skillStyles.iconContainer}>
          <div className={`${item.box} ${skillStyles.box}`}>{item.svg}</div>
        </div>
      ))}
    </section>
  );

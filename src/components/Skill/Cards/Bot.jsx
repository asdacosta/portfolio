  ...
  return (
    <section className={skillStyles.bot}>
      ...
      <div className={skillStyles.info}>
        <h2>AI Developer</h2>
        <p>
          I design and implement artificial intelligence solutions using machine
          learning and neural networks. I create intelligent systems, including
          <strong> CHATBOTS</strong>, to solve complex problems, automate tasks,
          and enhance user experiences, staying at the forefront of AI
          advancements.
        </p>
      </div>
    </section>

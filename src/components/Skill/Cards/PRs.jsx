...
function PRsComponent() {
  ...
  return (
    <motion.section className={skillStyles.PRs}>
      {memoizedSvg}
      ...
      >
        ...
        <p>
          ...
          quality, debugging, documentation, and collaborative development
          within large-scale engineering teams.
        </p>
      </motion.div>
    </motion.section>
  );
...
const PRs = React.memo(PRsComponent);
